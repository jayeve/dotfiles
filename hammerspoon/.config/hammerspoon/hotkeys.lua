...
hs.hotkey.bind(hyper, "y", function()
	hs.application.launchOrFocus(Apps.youtube)
end)
...
hs.hotkey.bind(hyper, "s", function()
	hs.application.launchOrFocus(Apps.safari)
end)
...
tmuxMode:bind("", "l", function()
	-- l for home "lab"
	targetLocation("raspberry")
	tmuxMode:exit()
end)
...
local scriptMode = hs.hotkey.modal.new(hyper, "4")
